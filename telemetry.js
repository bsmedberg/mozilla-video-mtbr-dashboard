...
/**
 * Returns the sum of all data points in this histogram.
 */
Histogram.prototype.sum = function Histogram_sum() {
  if (this.kind() != "linear" && this.kind() != "exponential" && this.kind() != "count") {
    throw new Error("Histogram.sum() is only available for linear/exponential/count histograms");
  }
